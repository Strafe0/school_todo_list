...
class _TaskService implements TaskService {
  ...
  @override
  Future<ListResponse> getAll() async {
  ...
  @override
  Future<ElementResponse> getById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = id;
    ...
    final value = ElementResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<ElementResponse> deleteTask(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
